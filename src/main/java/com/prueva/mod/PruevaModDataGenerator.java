...
public class PruevaModDataGenerator implements DataGeneratorEntrypoint {
	@Override
	...
	public void buildRegistry(RegistryBuilder registryBuilder) {
		...
		registryBuilder.addRegistry(RegistryKeys.BIOME, ModThirstyBiome::bootstrapt);
	}
}
